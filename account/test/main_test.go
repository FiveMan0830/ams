...
func setup() {
	...
	accountManagement.CreateGroupDepre(adminUser, adminPassword, group1.name, group1.groupLeaderUsername, group1.ID)
	accountManagement.CreateGroupDepre(adminUser, adminPassword, group2.name, group2.groupLeaderUsername, group2.ID)
...
func teardown() {
	...
	accountManagement.DeleteGroupDepre(adminUser, adminPassword, group1.name)
	accountManagement.DeleteGroupDepre(adminUser, adminPassword, group2.name)
